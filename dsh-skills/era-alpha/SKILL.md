---
name: era-alpha
description: "时代α捕手：高增长核心资产的识别-验证-持有框架"
---

## DeepSeek Harness adapter note

This skill is generated from `skills/era-alpha.md` so Claude Code, Codex, Cursor, and DeepSeek Harness users share one canonical workflow.
