...
description: "Income Investment: Durable and Opportunistic Distribution Analysis"
---

## DeepSeek Harness adapter note

This skill is generated from `skills/income-investment.md` so Claude Code, Codex, Cursor, and DeepSeek Harness users share one canonical workflow.
