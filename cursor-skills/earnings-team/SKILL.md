---
name: earnings-team
description: "AI Berkshire skill: 财报精读团队：四大师并行解读 + 公众号发布. Use when the user asks for /earnings-team or investment research workflows from this project. Source: skills/earnings-team.md."
---

## Cursor adapter note

This skill is generated from `skills/earnings-team.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
