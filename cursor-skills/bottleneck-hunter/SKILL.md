...
description: "AI Berkshire skill: 供应链瓶颈猎手：AI驱动的全球产业链瓶颈套利. Use when the user asks for /bottleneck-hunter or investment research workflows from this project. Source: skills/bottleneck-hunter.md."
---

## Cursor adapter note

This skill is generated from `skills/bottleneck-hunter.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
