---
name: dyp-ask
description: "AI Berkshire skill: 段永平问答：以他的方式思考. Use when the user asks for /dyp-ask or investment research workflows from this project. Source: skills/dyp-ask.md."
---

## Cursor adapter note

This skill is generated from `skills/dyp-ask.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
