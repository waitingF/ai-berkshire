---
name: era-alpha
description: "AI Berkshire skill: 时代α捕手：高增长核心资产的识别-验证-持有框架. Use when the user asks for /era-alpha or investment research workflows from this project. Source: skills/era-alpha.md."
---

## Cursor adapter note

This skill is generated from `skills/era-alpha.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
