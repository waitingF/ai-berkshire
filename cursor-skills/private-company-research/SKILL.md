...
description: "AI Berkshire skill: 未上市公司研究：多Agent并行深度研究框架. Use when the user asks for /private-company-research or investment research workflows from this project. Source: skills/private-company-research.md."
---

## Cursor adapter note

This skill is generated from `skills/private-company-research.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
