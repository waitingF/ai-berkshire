...
description: "AI Berkshire skill: 投研团队：四角色并行分析框架. Use when the user asks for /investment-team or investment research workflows from this project. Source: skills/investment-team.md."
---

## Cursor adapter note

This skill is generated from `skills/investment-team.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
