---
name: financial-data
description: "AI Berkshire skill: 财务数据获取与交叉验证规范. Use when the user asks for /financial-data or investment research workflows from this project. Source: skills/financial-data.md."
---

## Cursor adapter note

This skill is generated from `skills/financial-data.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
