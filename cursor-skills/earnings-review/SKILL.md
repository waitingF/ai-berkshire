...
description: "AI Berkshire skill: 财报精读：一手资料深度解读. Use when the user asks for /earnings-review or investment research workflows from this project. Source: skills/earnings-review.md."
---

## Cursor adapter note

This skill is generated from `skills/earnings-review.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
...
将报告写入 `reports/{公司名}/{公司名}-earnings-{期间}.md`（目录不存在则创建），例如 `reports/腾讯/腾讯-earnings-2025Q4.md`
