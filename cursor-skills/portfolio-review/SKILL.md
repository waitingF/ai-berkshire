...
description: "AI Berkshire skill: 组合管理：从\"研究公司\"到\"管理组合\". Use when the user asks for /portfolio-review or investment research workflows from this project. Source: skills/portfolio-review.md."
---

## Cursor adapter note

This skill is generated from `skills/portfolio-review.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
