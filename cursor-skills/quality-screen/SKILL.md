---
name: quality-screen
description: "AI Berkshire skill: 去劣筛选：7条指标快速排除非一流公司. Use when the user asks for /quality-screen or investment research workflows from this project. Source: skills/quality-screen.md."
---

## Cursor adapter note

This skill is generated from `skills/quality-screen.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
