...
description: "AI Berkshire skill: 深度公司系列：8 篇长文拆一家公司. Use when the user asks for /deep-company-series or investment research workflows from this project. Source: skills/deep-company-series.md."
---

## Cursor adapter note

This skill is generated from `skills/deep-company-series.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
