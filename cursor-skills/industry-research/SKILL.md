...
description: "AI Berkshire skill: 行业投资研究：产业链全景扫描 + 四大师个股分析框架. Use when the user asks for /industry-research or investment research workflows from this project. Source: skills/industry-research.md."
---

## Cursor adapter note

This skill is generated from `skills/industry-research.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
