---
name: wechat-article
description: "AI Berkshire skill: 微信公众号文章：作者-编辑-读者三Agent协作. Use when the user asks for /wechat-article or investment research workflows from this project. Source: skills/wechat-article.md."
---

## Cursor adapter note

This skill is generated from `skills/wechat-article.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
