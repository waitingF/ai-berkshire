...
description: "AI Berkshire skill: 管理层纵深研究：买股票就是买人. Use when the user asks for /management-deep-dive or investment research workflows from this project. Source: skills/management-deep-dive.md."
---

## Cursor adapter note

This skill is generated from `skills/management-deep-dive.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
...
将报告写入 `reports/{公司名}/{公司名}-management-{YYYYMMDD}.md`（目录不存在则创建），例如 `reports/美团/美团-management-20260409.md`
