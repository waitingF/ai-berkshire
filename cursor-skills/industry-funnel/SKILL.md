...
description: "AI Berkshire skill: 行业漏斗筛选：从全市场到 3 家的价值投资精选流程. Use when the user asks for /industry-funnel or investment research workflows from this project. Source: skills/industry-funnel.md."
---

## Cursor adapter note

This skill is generated from `skills/industry-funnel.md` so Claude Code, Codex, and Cursor users share one canonical workflow.
