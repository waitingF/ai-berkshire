---
name: weekly-review
description: "AI Berkshire skill: 周检：重点优先的研究待办分诊. Source: skills/weekly-review.md."
---

## Codex adapter note

This skill is generated from `skills/weekly-review.md` so Claude Code and Codex users share one canonical workflow.
