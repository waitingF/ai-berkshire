    ...
    def test_build_site_renders_markdown_index_and_static_assets(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (report_dir / "最终报告.md").write_text(
                ...
                "| --- | --- |\n"
                "| 护城河 | 强 |\n\n"
                "详见 [thesis](腾讯-thesis.md#假设) 与 [买卖建议](../买卖建议跟踪表.md)。\n\n"
            ...
            (reports_dir / "重点标的看板.md").write_text(
                "# 重点标的看板\n\n"
                "跳转 [买卖建议跟踪表.md](买卖建议跟踪表.md) 与 [thesis](腾讯/腾讯-thesis.md)。\n",
                encoding="utf-8",
            )
            (reports_dir / "买卖建议跟踪表.md").write_text(
                "# 买卖建议跟踪表\n\n"
                "| ID | 标的 | 建议日 | 来源 | 动作 | 锚定价 |\n"
                "| --- | --- | --- | --- | --- | --- |\n"
            ...
            self.assertEqual(
                builder.rewrite_markdown_href("../买卖建议跟踪表.md#命中率"),
                "../买卖建议跟踪表.html#命中率",
            )
            self.assertEqual(
